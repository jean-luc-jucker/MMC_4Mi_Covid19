...
#GET DATA##################################################
#asia
asia <- read_xlsx("data/04_MMC_Asia_Covid19_20200409_01_WorkingFile_20200525.xls", na = "", sheet = 3) #file is xlsx despite extension
#eay
eay <- read_excel("data/04_MMC_EAY_Covid19_ValidatedData_20200417_20200521.xlsx", na = "", sheet = 3)
#lac
lac <- read_excel("data/04_MMC_LAC_Covid19_ValidatedData_20200522_102449.xlsx", na = "", sheet = 3) 
# na
na <- read_excel("data/04_MMC_NA_Covid19_NA_DataforGVA_20200407_20200521_2.xlsx", na = "") #note 2 cols have same id, 'c10_1'
#wa
wa <- read_excel("data/04_MMC_WA_Covid19_GlobalValidatedData_20200511_20200525.xlsx", na = "", sheet = 3)
...
#SAVE######################################################
#rda
save(data, file = "rda/04_cleaned_data_20200528.rda") 
#csv
write.csv(data, "data_outputs/04_cleaned_data_20200528.csv")
#column names
write.csv(colnames(data), "data_outputs/04_variables_names_20200528.csv")
