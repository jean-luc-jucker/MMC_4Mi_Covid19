...
#lac
lac <- read_excel("data/03_MMC_LAC_Covid19_ValidatedData_20200508_095027.xlsx", na = "", sheet = 3) #note 2 cols have same id, 'c10_1'
# na
na <- read_excel("data/03_MMC_NA_Covid19_NA_DataforGVA_20200407_20200507.xlsx", na = "")
#wa
...
dim(na) #958obs 414vars
dim(wa) #646obs 439vars
View(asia)
View(lac)
View(na)
View(wa)
...
#BIND####
data <- rbind(asia2, lac2, na2, wa2)
dim(data) #2110 obs, 195 vars
View(data)

#DEFINE VARIABLE TYPES####
str(data)
numerics <- c(4, 194:195)
...
#SAVE####
#rda
save(data, file = "rda/03_cleaned_data_20200512.rda") 
#csv
write.csv(data, "data_outputs/03_cleaned_data_20200512.csv")
